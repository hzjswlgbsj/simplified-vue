...
const TAG$3 = 'runtime-core/component';
...
function setupStatefulComponent(instance) {
    ...
    if (setup) {
        ...
        console.log(TAG$3, 'setupStatefulComponent->初始化组件结束', instance);
    }
}
/**
...
//---------------------------createRenderer-------------------------------
const TAG$2 = 'src/runtime-core/renderer';
function createRenderer(options) {
    ...
    function mountElement(vnode, container, parentComponent, anchor) {
        console.log(TAG$2, 'mountElement->开始执行DOM元素类型的的初始化挂载', vnode);
    ...
    function patchElement(n1, n2, container, parentComponent, anchor) {
        console.log(TAG$2, 'patchElement', '开始执行DOM元素类型的更新操作', n1, n2);
        /* 更新 props */
    ...
    function patchProps(el, oldProps, newProps) {
        console.log(TAG$2, 'patchProps', '开始执行DOM元素类型的更新操作-处理属性', el, oldProps, newProps);
        ...
        for (let i = toBePatched - 1; i >= 0; i--) {
            ...
            if (newIndexToOldIndexMap[i] === 0) {
                ...
                if (j < 0 || i !== increasingNewIndexSequence[j]) {
                    console.log(TAG$2, 'patchKeyedChildren', '中间对比-需要移动', i);
    ...
    function setupRenderEffect(instance, initialVNode, container, anchor) {
        ...
        instance.update = effect(() => {
            ...
            if (!instance.isMounted) {
                ...
                console.log(TAG$2, 'setupRenderEffect->执行了初始化渲染', instance);
            }
            else {
                /* 更新流程 */
                ...
                console.log(TAG$2, 'setupRenderEffect', '执行了更新渲染', instance, subTree, preSubTree);
            }
        }, 
        ...
        {
            scheduler() {
                console.log(TAG$2, 'setupRenderEffect-effect-scheduler: 执行了更新操作的调度器，开始收集试图更新任务');
...
export { createApp, createElement, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, insert, nextTick, patchProp, provide, proxyRefs, ref, registerRuntimeCompiler, remove, renderSlots, setElementText, toDisplayString };
